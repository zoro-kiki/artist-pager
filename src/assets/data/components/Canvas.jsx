...
const Canvas = () => {
    ...
    return (
        <main ref={containerRef} className="fixed inset-0 bg-[#070707] overflow-hidden cursor-none touch-pan-x touch-pan-y">
            ...
            <nav className="fixed top-6 left-0 w-full z-[100] flex flex-wrap justify-center items-center gap-3 md:gap-4 pointer-events-none px-4 md:px-6">
                ...
                <div className="pointer-events-auto bg-white/5 backdrop-blur-2xl border border-white/10 p-3 px-8 rounded-full shadow-xl">
                    <input
                        ...
                        className="bg-transparent text-[16px] md:text-[11px] tracking-[0.2em] md:tracking-[0.3em] uppercase outline-none w-24 sm:w-32 md:w-48 text-white placeholder:text-white/20"
                    />
                </div>

                {/* CATEGORY */}
                <div className="pointer-events-auto bg-white/5 backdrop-blur-2xl border border-white/10 p-2 md:p-3 px-3 md:px-6 rounded-full shadow-xl">
                    <select
                ...
                {/* COUNTRY SEARCHABLE */}
                <div className="pointer-events-auto w-[140px] sm:w-[180px] md:w-[220px]">
                    <Select
